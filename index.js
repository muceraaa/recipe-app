...
const searchMeal = () =>{
    ...
    // Checking if the user searched for anything
    if(mealInput){
        ...
        // Clear meal details after every search
...
const showMealDetailsDiv = data => {
    ...
    // Set the contents of every paragraph in the meal details 
...
const getMealDetails = mealID => {
    // Clear the meal details section for a new search
    const mealDetailsSection = document.getElementById('meal-details-section');
    mealDetailsSection.innerHTML = ``;
